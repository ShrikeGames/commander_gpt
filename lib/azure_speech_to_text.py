...
class SpeechToTextManager:
    ...
    def __init__(self, azure_tts_key:str, azure_tts_region:str):
        ...
        try:
            ...
            self.output_speech_config = speechsdk.SpeechConfig(subscription=azure_tts_key, region=azure_tts_region)
            self.output_audio_config = speechsdk.audio.AudioOutputConfig(use_default_speaker=True)
    ...
    def texttospeech_from_text(self, azure_voice_name:str, azure_voice_style:str = "", text_to_speak:str = "") :
        ...
        speech_synthesizer = speechsdk.SpeechSynthesizer(speech_config=self.output_speech_config, audio_config=self.output_audio_config)
    ...
    def speechtotext_from_mic_continuous(self, stop_key='8', commander_gpt=None):
        ...
        self.azure_audioconfig = speechsdk.audio.AudioConfig(use_default_microphone=True)#, device_name="sysdefault:CARD=Snowball")
        self.azure_speechrecognizer = speechsdk.SpeechRecognizer(speech_config=self.azure_speechconfig, audio_config=self.azure_audioconfig)
